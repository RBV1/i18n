...
import { type H3Event, type H3EventContext } from 'h3';
...
export declare function initializeI18nContext(event: H3Event): Promise<{
    /**
     * Cached locale configurations based on runtime config
     * @internal
     */
 ...
 * @internal
 */
export declare const fetchMessages: (locale: string, event?: H3Event) => Promise<LocaleMessages<DefineLocaleMessage>>;
